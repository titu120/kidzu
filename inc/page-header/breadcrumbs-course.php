<?php 
    ...
    if($post_meta_data == ''){
        if(!empty($heartly_option['course_banner']['url'])):
    ...
    if(!empty($heartly_option['show_banner__course'])):
      $post_meta_data = $heartly_option['show_banner__course'];
    endif;
?>
...
<div class="themephi-breadcrumbs  porfolio-details">
    ...
    <div class="breadcrumbs-single" style="background:<?php echo esc_attr($heartly_option['breadcrumb_bg_color']);?>"> 
        ...
        <?php } elseif(!empty($heartly_option['course_banner']['url'])){ 
        $course_banner = $heartly_option['course_banner']['url'];?>
